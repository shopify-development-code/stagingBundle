...
const CustomizationEditor = (props) => {
  ...
  const handleCustomizeSave =async()=>{
    ...
    const response = await postApi("/api/admin/updateCustomization",props.data,app)
  ...
  const handleBundleOption = (bundleName) => {
    if (props.bundleOption != bundleName) {
      ...
      bundleName=="collection" || bundleName=="bundle" || bundleName=="volume" ? setCustomOption("Box") : ""
    }
  };
  ...
  const leftSideSectionCommon = () => {
    return (
      ...
      <div className="sd-bundle-listItem-wrapper">
       ...
       {props.bundleOption == "collection" && <div
  ...
  return (
    ...
    <div className="sd-bundle-customizationBundle-wrapper">
      <div className="sd-bundle-customizationBundle-topbar">
        <div>
          <Button className="sd-bundle-backArrow" onClick={() => navigate("/customization")}>
            <ArrowLeftOutlined />
          </Button>
        </div>
      ...
      <div className="sd-bundle-mainContent-wrapper">
        <div className="sd-bundle-leftSider">
          <p className="sd-bundle-displayOption-section">{displayOption}</p>
          <Divider />
          ...
          <div className="sd-bundle-bundleList-section">
            ...
            {props.bundleOption == "collection" ? leftSideSectionCommon() : ""}
          </div>
          : 
          displayOption =="popUp" ? 
          <div className="sd-bundle-bundleList-section">
...
{ displayOption == "productPages" ?
          ...
          :
            ...
            customOption == "productDetails" && (props.bundleOption == "bundle" || props.bundleOption == "volume")  ?
              <ProductDetails
                bundleOption={props.bundleOption}
                data={props.data}
                setData={props.setData}
              ...
              />
            :
            customOption == "collectionDetails" && props.bundleOption=="collection"  ?
              <CollectionDetails
                bundleOption={props.bundleOption}
                data={props.data}
                setData={props.setData}
            ...
            customOption == "Total_section" &&  (props.bundleOption == "bundle"  || props.bundleOption == "volume")  ? 
              <TotalSection
                bundleOption={props.bundleOption}
                data={props.data}
                setData={props.setData}
            ...
            customOption == "Button" ?
              ...
              />
          :
            customOption == "Options" && props.bundleOption == "volume" ? 
              <Options
                bundleOption={props.bundleOption}
                data={props.data}
                setData={props.setData}
              ...
              />
          :
            customOption == "DiscountBadge" && props.bundleOption=="collection" ?
              <DiscountBadge
                bundleOption={props.bundleOption}
                data={props.data}
                setData={props.setData}
