...
const CustomizationCollectionBundlePreview = ({ data }) => {
  ...
  const textStyle = {
    fontFamily:  `${data?.collection?.box?.fontFamily || 'inherit'}`
  };
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundColor: data?.collection?.DiscountBadge?.backgroundColor
          }}          
        >
          <span
            style={{
              ...
              fontSize: `${data?.collection?.DiscountBadge?.fontSize || 16}px`
            }}            
          >
        ...
        <div class="sd-bundle-text-detail">
          <h4
            style={{
              ...
              fontSize: `${data?.collection?.title?.fontSize || 16}px`,
          ...
          <p
            style={{
              ...
              fontSize: `${data?.collection?.title?.descriptionFontSize || 16}px`,
          ...
          <div class="sd-bundle-product-inner">
            ...
            <div class="sd-bundle-product-name">
              <h5
                style={{
                  ...textStyle,
                  color: data?.collection?.collectionDetails?.title?.color,
                  fontSize: `${data?.collection?.collectionDetails?.title?.fontSize || 16}px`
                }}                
              >
                Wireless collection
              </h5>
              <p
                style={{
                  ...textStyle,
                  color: data?.collection?.collectionDetails?.description?.color,
                  fontSize: `${data?.collection?.collectionDetails?.description?.fontSize || 16}px`
                }}                
              >
