    ...
    if (x == "dark") {
      setData({
        ...
        [bundleOption]: {
          ...
          button: {
            ...data[bundleOption]["button"],
            backgroundColor: "#000000",
            color: "#FFFFFF",
          },
          title: { ...data[bundleOption]["title"], color: "#FFFFFF" },
          productDetails: {
            ...data[bundleOption]["productDetails"],
            title: {
              ...data[bundleOption]["productDetails"]["title"],
              color: "#FFFFFF",
            },
            price: { ...data[bundleOption]["price"], color: "#FFFFFF" },
            image: { borderColor: "#FFFFFF", borderRadius: 0 },
            quantities: {
              ...data[bundleOption]["quantities"],
              color: "#000000",
          ...
          totalSection: {
            ...data[bundleOption]["totalSection"],
            backgroundColor: "#FFFFFF",
            color: "#000000",
          },
        },
    ...
    if (x == "dark") {
      setData({
        ...
        [bundleOption]: {
          ...
          title: {
            ...data[bundleOption]["title"],
            color: "#FFFFFF",
            description: {
              ...data[bundleOption]["title"]["description"],
              color: "#ffffff",
            },
          },
          collectionDetails: {
            ...
            title: {
              ...data[bundleOption]["collectionDetails"]["title"],
              color: "#FFFFFF",
            },
            plus: { color: "#5e5e5e", backgroundColor: "#FFFFFF" },
      ...
      setData({
        ...
        [bundleOption]: {
          ...
          collectionDetails: {
            ...
            plus: { color: "#000000", backgroundColor: "#FFFFFF" },
