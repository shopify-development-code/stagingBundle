      ...
      <Card sectioned>
        ...
        <BlockStack vertical>
          <RadioButton
            ...
            id="percent"
            value="percent"
            checked={props.discountType == "percent"}
            onChange={(e, id) => {
              props.handleDiscountType(id);
            }}
          />
          ...
          <RadioButton
            ...
            value="fixed"
            checked={props.discountType == "fixed"}
            id="fixed"
            onChange={(e, id) => {
              props.handleDiscountType(id);
            }}
          ...
          <RadioButton
            ...
            value="freeShipping"
            id="freeShipping"
            checked={props.discountType == "freeShipping"}
            onChange={(e, id) => {
              props.handleDiscountType(id);
            }}
          />
          <RadioButton
            ...
            value="noDiscount"
            id="noDiscount"
            checked={props.discountType == "noDiscount"}
            onChange={(e, id) => {
              props.handleDiscountType(id);
            }}
          />
