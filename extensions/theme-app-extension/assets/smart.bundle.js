...
let server = "https://stay-gardens-nearly-prisoner.trycloudflare.com";
console.log("Smart Bundle Discount 1111111");
        ...
        el?.bundleDetail?.products?.map((ele, index) => {
          ...
          for (let i = 1; i <= ele?.minimumOrder; i++) {
            ...
            if (ele.variants.length > 1) {
              ...
              let currentSelect = BUNDLE_SELECT;

              show_more.addEventListener("click", function (e) {
                currentSelect.classList.remove("sd-bundle-hide-click");
              ...
              show_less.addEventListener("click", function (e) {
                if (i > 2) {
                  currentSelect.classList.add("sd-bundle-hide-click");
                }
                seeLessDiv.classList.add("sd-bundle-hide-click");
          ...
          el.bundleDetail.products.map((elem, index) => {
           ...
           if (ele?.badgeText != "" && ele?.badgeText != undefined) {
            ...
            for (let i = 1; i <= ele.quantity; i++) {
              let VOLUME_SELECT = document.createElement("select");
              ...
              VOLUME_SELECT.classList.add("volumeDiscount" + volumeIndex + bundleIndex);
              ...
              elem.variants.map((element) => {
                ...
                if (
                  ...
                  VOLUME_OPTION.value = element.id.replace("gid://shopify/ProductVariant/", "");
                }
              ...
              let currentSelect = VOLUME_SELECT;
              show_more.addEventListener("click", function () {
                currentSelect.classList.remove("sd-volume-hide-click");
              ...
              show_less.addEventListener("click", function () {
                if (i > 2) {
                  currentSelect.classList.add("sd-volume-hide-click");
                }
                seeLessDiv.classList.add("sd-volume-hide-click");
